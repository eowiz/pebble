...
public final class Listz {
  ...
  @NotNull
  public static <T> List<@Nullable T> repeat(
      int n, @NotNull T seed, @NotNull UnaryOperator<@NotNull T> generator) {
    return repeat(n, generator.apply(seed));
  }

  @NotNull
  public static <T> List<@Nullable T> repeat(int n, @Nullable T t) {
    return repeat(n, () -> t);
  }

  @NotNull
  public static <T> List<@Nullable T> repeat(int n, @NotNull Supplier<@Nullable T> supplier) {
